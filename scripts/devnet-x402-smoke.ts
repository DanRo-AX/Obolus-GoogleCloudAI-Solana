...
if (quote.asset !== DEVNET_USDC) throw new Error(`expected Circle Devnet USDC, received ${quote.asset}`)
...
if (!receipt.success || !receipt.transaction) throw new Error('facilitator receipt was unsuccessful')
