/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 499b0f4a0d9eac495b70d2cb1b3180f9)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	API_ORIGIN: "https://obolus-api-amjeodet3q-du.a.run.app";
	GATEWAY_ORIGIN: "https://obolus-gateway-amjeodet3q-du.a.run.app";
	OPENSHELF_DEFAULT_RECEIVER: string;
	OPENSHELF_BUNDLE_RECEIVER: string;
	OPENSHELF_ENV: string;
	OPENSHELF_INTERNAL_TOKEN: string;
	OPENSHELF_BIND: string;
	OPENSHELF_DATABASE: string;
	OPENSHELF_X402_NETWORK: string;
	OPENSHELF_X402_ASSET: string;
	OPENSHELF_KRW_PER_USDC: string;
	OPENSHELF_QUOTE_TTL_MS: string;
	RUST_API_URL: string;
	...
	VITE_BACKEND_ENABLED: string;
	VITE_X402_ENABLED: string;
	VITE_X402_GATEWAY_BASE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_ORIGIN" | "GATEWAY_ORIGIN" | "OPENSHELF_DEFAULT_RECEIVER" | "OPENSHELF_BUNDLE_RECEIVER" | "OPENSHELF_ENV" | "OPENSHELF_INTERNAL_TOKEN" | "OPENSHELF_BIND" | "OPENSHELF_DATABASE" | "OPENSHELF_X402_NETWORK" | "OPENSHELF_X402_ASSET" | "OPENSHELF_KRW_PER_USDC" | "OPENSHELF_QUOTE_TTL_MS" | "RUST_API_URL" | "X402_FACILITATOR_URL" | "X402_NETWORK" | "X402_RPC_URL" | "PORT" | "FRONTEND_ORIGIN" | "VITE_API_PROXY_TARGET" | "VITE_BACKEND_ENABLED" | "VITE_X402_ENABLED" | "VITE_X402_GATEWAY_BASE">> {}
}
